...
function runsimlong(p,w0Index,w0Weights,nc0,wpIndexOut,wpWeightOut,ncpOut,stim,ffwdRate,wpWeightFfwd,simtime)
...
train_time = simtime*1000 ################## LONG SIMULATION ################
dt = copy(p.dt) # time param
# Nsteps = copy(p.Nsteps) 
Nsteps = Int(train_time/dt) ################## LONG SIMULATION ################

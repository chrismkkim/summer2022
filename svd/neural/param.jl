...
penlamEE       = lam_list[jj]; # 3.0
penlamEI       = lam_list[jj]; # 3.0
penlamIE       = lam_list[jj]; # 3.0
penlamII       = lam_list[jj]; # 3.0
penmu          = 8.0; # 2.0
frac           = 1.0;
learn_every    = 20.0
...
Lexc = L # excitatory L
Linh = L # inhibitory L
wpscale = sqrtK * 0.5 * (L_list[ll]/2.0)

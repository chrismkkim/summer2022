...
dirdata = "/home/grabelmz/code/distributedActivity-main/data_network/"
...
fname_times = dirsim * "times_R_$(repi).jld2"
fname_ns = dirsim * "ns_R_$(repi).jld2"
...
fname_times = dirsim * "times_L_$(repi).jld2"
fname_ns = dirsim * "ns_L_$(repi).jld2"
